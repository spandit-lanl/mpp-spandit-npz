...
python train_basic.py --run_name lsc240420_nsteps_4_gpu80 --config basic_config --yaml_config config/mpp_lsc_avit_ti_config_nsteps_4.yaml &>>output_lsc240420_nsteps_4_gpu80.txt
