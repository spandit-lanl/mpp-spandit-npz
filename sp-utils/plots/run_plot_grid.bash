...
#python3 05_plot_grid_losses_range.py --phase pretrain --which even --nstep_min 1 --nstep_max 8  --output pretrain_1to8_grid.png
#python3 05_plot_grid_losses_range.py --phase finetune --which even --nstep_min 1 --nstep_max 8  --output finetune_odd_1to8_grid.png
set +x
