...
python train_basic.py --run_name lsc240420_nsteps_8_gpu40 --config basic_config --yaml_config config/mpp_lsc_avit_ti_config_nsteps_8.yaml &>>output_lsc240420_nsteps_8_gpu40.txt
