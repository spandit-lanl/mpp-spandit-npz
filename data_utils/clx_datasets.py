...
class ClxNpzDataset(Dataset):
    ...
    def get_name(self, full_name=False):
        return "clx_npz"  # or whatever label you want to appear in logs

    def __getitem__(self, idx: int):
        selected_fields = [
    "av_density", "av_pressure", "av_temperature", "burn_frac_booster", "burn_frac_maincharge", "density_booster", "density_maincharge", "energy_booster",
        ]
